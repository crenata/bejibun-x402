...
const {default: X402} = await import("@bejibun-baseline/x402");
const {default: X402Builder} = await import("@bejibun-baseline/x402/builders/X402Builder");
const {default: BunAdapter} = await import("@bejibun-baseline/x402/builders/BunAdapter");
